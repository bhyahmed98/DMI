            ...
            <div>
                <aside className="main-sidebar sidebar-light-primary elevation-4">
                    ...
                    <a href="../index3.html" className="brand-link">
                        <img src="../../dist/img/logo.png" alt="logo taraji" className="brand-image img-circle elevation-3" style={{opacity: '.8'}} />
                        <span className="brand-text font-weight-light">Espérance</span>
                    </a>
                    <div className="sidebar">
                        ...
                        {/*<div className="container mt-3 pb-5 mb-10 d-flex">*/}
                        {/*    <img src="dist/img/user2-160x160.jpg" className="img-circle elevation-2" alt="User Image" />*/}
                        {/*    <br></br>*/}
                        {/*    <h2>Alexander Pierce</h2>*/}
                        {/*</div>*/}
                        {/*<div height="800px" width="50px">*/}
                        ...
                        {/*        <h4 color="f8f9fa"> Welcome</h4>*/}
                        {/*        <h6 color="f8f9fa">  Dr.Anis Haddad</h6>*/}
                        {/*    </div>*/}
                        {/*</div>*/}
                        {/*/!* SidebarSearch Form *!/*/}
               ...
               with font-awesome or any other icon font library */}
                                ...
                                <li className="nav-item">
                                    <a href="pages/calendar.html" className="nav-link">
                                        <i className="fa icon fa-home nav-icon"> </i>
                                        <p>
                                            Home
                                        </p>
                                    </a>
                                ...
                                <li className="nav-item">
                                    <a href="pages/gallery.html" className="nav-link">
                                        <i className="fa icon fa-file-signature nav-icon" > </i>
                                        <p >    Consigne</p>
                                    </a>
                                </li>
                                <li className="nav-item">
                                    <a href="pages/kanban.html" className="nav-link">
                                        <i className="fa icon fa-bell nav-icon"> </i>
                                        <p>
                                            Feedback
                                ...
                                <li className="nav-item">
                                    <a href="pages/calendar.html" className="nav-link">
                                        <i className="fa icon fa-sign-out-alt nav-icon"> </i>
                                        <p>
                                            Logout
                                        </p>
                                    </a>
